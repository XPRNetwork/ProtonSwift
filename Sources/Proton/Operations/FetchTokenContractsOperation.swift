...
//                                                      symbol: row.symbol, url: row.url, blacklisted: row.blisted)
                    ...
                    let tokenContract = TokenContract(chainId: "123", contract: Name(stringValue: "contract"),
                    issuer: Name(stringValue: "contract"), resourceToken: false, systemToken: false,
                    name: "name", description: "desc", iconUrl: "row.iconurl",
                    supply: Asset(0.0, try! Asset.Symbol(4, "EOS")), maxSupply: Asset(0.0, try! Asset.Symbol(4, "EOS")),
                    symbol: try! Asset.Symbol(4, "EOS"), url: "", blacklisted: false)
